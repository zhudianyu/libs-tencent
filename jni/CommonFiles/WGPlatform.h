...
private:
    ...
    WGQQGroupObserver* mQQGroupObserver;
...
public:
	...
	WGQQGroupObserver* GetQQGroupObserver() const;
	 ...
	 * 手Q加群加好友回调
	 */
	void WGSetQQGroupObserver(WGQQGroupObserver* pQQGroupObserver);
